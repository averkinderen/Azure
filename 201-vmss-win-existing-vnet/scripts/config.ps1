...
.\connect.client.exe --server "10.0.0.4" --port "8888" --name $machine --username "marketsims" --password "M@rket%^TYghbn" –worker-count 12 --export-config "C:\Users\marketsims\AppData\Roaming\PLEXOS\PLEXOS Connect Client.xml"
